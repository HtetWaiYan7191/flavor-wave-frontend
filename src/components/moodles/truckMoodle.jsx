    ...
    <Moodle buttonName={"Assignment"}>
      <div className="grid gap-1 py-2">
        <section className=" relative flex flex-col justify-start w-full rounded-lg">
          ...
          <Blah
            onSelectInfo={(selectedTruck) => setSelectedTruck(selectedTruck)}
          />
          {validateError && (
            <p className="text-red-500">Please select a truck no.</p>
          )}
          <Button className={`w-fit my-2`} onClick={handleSumbit}>
            Submit
          </Button>
        </section>
      </div>
